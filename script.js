...
const GPA_LABELS = [
  ...
  { min: 3.0, label: "Mehnat Rang Laye 💪", color: "#70e8a2" },
  { min: 2.67, label: "Guzara Ho Jayega 😅", color: "#60d0f5" },
  { min: 2.33, label: "Zara Aur Parh Lo Bhai 😐", color: "#a0c4ff" },
  { min: 2.0, label: "Amma Ne Dekh Liya Toh... 😬", color: "#f5c860" },
  { min: 1.33, label: "Abbu Ka Phone Aa Raha Hai ☎️", color: "#ff9a5c" },
  { min: 1.0, label: "Tuition Teacher Bulao 😭", color: "#ff7f50" },
  { min: 0.0, label: "Beta Dukaan Sambhalo 🏪", color: "#ff5c5c" },
];
